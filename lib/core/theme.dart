...
class JuhTheme {
  ...
  static ThemeData _build({required Brightness brightness}) {
    ...
    final colorScheme = ColorScheme(
      ...
      secondary: JuhColors.info,
      onSecondary: Colors.white,
      secondaryContainer: JuhColors.infoSoft,
      onSecondaryContainer: JuhColors.info,
      ...
      outlineVariant: isDark ? const Color(0xFF222736) : const Color(0xFFF0F4F8),
